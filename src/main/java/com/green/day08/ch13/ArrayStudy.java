...
public class ArrayStudy {
    /*
        ...
        int[] arr; 가 의미하는 바는 int 배열(객체)의 주소값을 저장한다.
        다른 타입의 배열의 주소값은 저장할 수 없다.

        new int[100]; int 형의 공간이 100개가 만들어졌다.
        각 공간은 int 값만 저장할 수 있다.

        new String[100]; String 형의 공간이 100개가 만들어졌다.
        ...
        숫자형은 0, 레퍼런스타입은 null, boolean 은 false
