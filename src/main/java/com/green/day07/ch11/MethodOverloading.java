...
public class MethodOverloading {
    /*
        오버로딩은 메소드에서만 나타나는 적용된다.
        오버로딩은 같은 이름의 메소드를 여러개 정의 할 수 있는 기법
    ...
    //public void sum(int n1, int n2) {return "String";} //리턴타입으로는 구분하지 않는다.
    //public void sum(int n2, int n1) {} 타입이 달라야함. //매개변수명으로 구분하지 않는다.

    class Test{
        public static void main(String[] args) {
            MethodOverloading d = new MethodOverloading(); // 위쪽 MethodOverloading 앞에 void 붙으면 이거 안됨.
        }
    }
