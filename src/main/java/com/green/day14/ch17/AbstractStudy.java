...
public abstract class AbstractStudy {
    /*
        ...
        class 앞에 abstract 를 붙이는 것은 선택사항이나 만약에 추상 메소드를 가지게 된다면
        선택사항이 아니라 필수사항이 된다.

        클래스간에 공통적인 부분을 부모에 작성을 해서 상속받도록 하기 위한 것.
...
} //추상클래스 상속 받아도 메소드 구현안하고 싶을때 abstract 붙인다.
...
class AbstractStudyTest {
    public static void main(String[] args) {
       //AbstractStudy as = new AbstractStudy(); //추상클래스라서 객체화 불가능
        ...
        as2.sum(); //AbstractStudy 는 sum 메소드 알고 있다. 고로 호출 가능하다.
    }
}
