...
public class UseVariable {
    public static void main(String[] args) {
        // 변수
        int num1; //변수 선언, 더 정확히 표혐: 정수형의 num1 이라는 변수명을 가진 정수형을 선언.
        ...
        // printf 는 문자열 안에 변수를 주입할때 사용.
        System.out.printf("num1: %d, num2: %d, num3: %d\n", num1, num2, num3);
        System.out.println("num1: " + num1 + ", num2: " + num2 + ", num3: " + num3);

        /*
        변수를 사용하ㅣ 위해서는 선언을 해야한다.
        ...
        변수를 사용하는 이유
        0. 데이터를 저장하기 위해서.
        1. 여러군데서 사용할 때 참조할 수 있도록 한다.
           왜냐, 값이 변경되었을 때 변수값만 수정을 하면 참조한 모든 곳이 변경이 되기 때문
         */
