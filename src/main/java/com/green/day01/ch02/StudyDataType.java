...
public class StudyDataType {
    public static void main(String[] args) {
        /*
            ...
            특징: 타입이름이 소문자로 되어 있고, 총 8개,  기본 타입을 제외한 나머지는 reference type (참조 타입)이다.

            *타입명 옆에 (숫자)는 바이트(크기)를 의민한다.
        ...
        int var4 = 100;
        long var5 = var4 + var4; //int 값이 long 타입에 들어가는데 문제가 안됨. 자동형변환이 된다.

        // int var6 = var5; //반대방향은 자동형변환이 되지 않는다.
        int var6 = (int)var5; //강제형변환을 하여야 한다.
        float var7 = var5; // 자동형변환이 된다.
    }
}
