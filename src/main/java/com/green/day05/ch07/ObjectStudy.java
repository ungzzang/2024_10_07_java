...
public class ObjectStudy {
    /*
        ...
        (객체화 과정이 필요없다. 다이렉트로 사용가능.) //이미 메모리에 올라가있음  인스턴스 메소드에서 부르면 쓸 수 있음.
        ...
        예를들어:
        Kal(클래스명) abc(변수명);
        abc는 변수는 Karl 객체의 주소값만 담을 수 있다. (저장할 수 있다.)
        참조변수끼리의 == 비교는 주소값이 같은지 비교한다.

        객체를 이용할 때는 "주소값." 으로 이용한다. (주소값+점)
     */
}
