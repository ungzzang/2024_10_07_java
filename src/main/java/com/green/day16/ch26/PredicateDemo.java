...
public class PredicateDemo {
    public static void main(String[] args) {
        ...
        System.out.println(preMore10.test(9)); //false
        System.out.println(preMore10.test(10)); //false
        System.out.println(preMore10.test(11)); //true
...
//        }; 헷갈려서 적으거라네요
        ...
        examPredicate(preMore10, 9); //false
        examPredicate(n -> n > 10, 9); //false
        examPredicate(n -> n > 10, 11); //true
    }
