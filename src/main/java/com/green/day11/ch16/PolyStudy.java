...
public class PolyStudy {
    /*
        ...
        2. 1번의 반대는 안된다. 자식타입에 변수는 부모객체 주소값 저장할 수 없다.
    ...
    public static void main(String[] args) {
        ...
        // 자식타입인 BullDog 에 부모객체인 Dog 객체 주소값을 담으려고 하니
        // 런타임 에러 발생
        ...
        */
        ...
        //instanceof: 형변환 가능형부, 가능 ture, 불가능 flase
        //왼쪽항 객체주소값 오를쪽항 타입(class)
